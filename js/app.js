...
function comprar() {
    ...
    if (tipoIngresso === 'pista') {
        ...
        if (quantidade <= quantidadeDisponivel) {
            ...
            alert(`Compra realizada com sucesso! Restam ${quantidadeDisponivel} ingressos de pista.`);
        } else {
        ...
        if (quantidade <= quantidadeDisponivel) {
            ...
            alert(`Compra realizada com sucesso! Restam ${quantidadeDisponivel} ingressos de superior.`);
        } else {
            alert('Quantidade de ingressos selecionada excede a disponível.');
        }
        ...
        if (quantidade <= quantidadeDisponivel) {
            ...
            alert(`Compra realizada com sucesso! Restam ${quantidadeDisponivel} ingressos de inferior.`);
        } else {
            alert('Quantidade de ingressos selecionada excede a disponível.');
        }
    }
